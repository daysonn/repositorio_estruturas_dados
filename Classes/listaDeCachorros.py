...
for i in range(qtd):
    ...
    cachorro_temp = Cachorro()
    cachorro_temp.inserirDados(nome, cor, raca, idade, nascimento)

    lista_de_cachorros.append(cachorro_temp)
...
####### Atividade ##########
# Exibir os dados de todos os cachorros
# Mover o cachorro de acordo com o nome
